...
_(Note: File PyScriptSystemTray.py is irrelevant to this program. This file contains python-program to start any python application in SystemTray :: Module: PyStray)_  
````cmd
pip install pystray
````
#### Codes
